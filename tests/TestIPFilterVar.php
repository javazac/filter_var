...
class TestIPFilterVar extends AbstractFilterVarTest
{
	...
	public function testValidateIPv6wFlags()
	{
		...
		$this->assertTrue(filter_var('fdfe:dcba:9876:ffff:fdc6:c46b:bb8f:7d4c', FILTER_VALIDATE_IP, FILTER_FLAG_IPV6|FILTER_FLAG_NO_PRIV_RANGE) === FALSE, 'FILTER_VALIDATE_IP (FILTER_FLAG_IPV6|FILTER_FLAG_NO_PRIV_RANGE) failed');
		$this->assertTrue(filter_var('fcfe:dcba:9876:ffff:fdc6:c46b:bb8f:7d4c', FILTER_VALIDATE_IP, FILTER_FLAG_IPV6|FILTER_FLAG_NO_PRIV_RANGE) === FALSE, 'FILTER_VALIDATE_IP (FILTER_FLAG_IPV6|FILTER_FLAG_NO_PRIV_RANGE) failed');
	}
